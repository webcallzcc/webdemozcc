...
export default class Notifier extends React.Component {
	...
	render() {
		return (
			<NotificationSystem ref={this.notificationSystemRef} style={STYLE} allowHTML={false} />
		);
	}
	...
	notify(data) {
		...
		this.notificationSystemRef.current.addNotification(data2);
	}

	hideNotification(uid) {
		this.notificationSystemRef.current.removeNotification(uid);
	}
}
